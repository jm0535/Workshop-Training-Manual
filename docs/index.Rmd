...
1.  **Installation and Setup:** We'll begin by guiding you through the installation of R, RStudio, and Jamovi on your computer. These tools are essential for conducting ecological data analysis efficiently.

2.  **Data Import and Cleaning:** Learn how to import ecological datasets into R and Jamovi. We'll cover techniques for cleaning and preprocessing data, ensuring that your analyses are based on high-quality, error-free data.

3.  **Exploratory Data Analysis (EDA):** Dive into the world of EDA, where you'll learn how to visualize and summarize ecological data. Discover patterns, relationships, and outliers in your datasets.

4.  **Statistical Tests:** Understand the fundamentals of statistical hypothesis testing. We'll explore common tests used in ecological research, such as t-tests, ANOVA, and non-parametric tests, and demonstrate how to conduct them in R and Jamovi.

5.  **Regression Analysis:** Delve into regression analysis to model ecological relationships. Learn about linear and logistic regression and discover how to interpret regression outputs.

6.  **Data Visualization:** Master the art of data visualization. Create informative graphs and plots to communicate your ecological findings effectively.

7.  **Advanced Topics:** As you progress, we'll introduce you to more advanced topics, such as multivariate analysis, spatial analysis, and time series analysis, opening doors to broader ecological research possibilities.

8.  **Case Studies:** Throughout the guide, you'll encounter real-world ecological case studies, demonstrating how R and Jamovi are applied to solve practical ecological problems.
...
This comprehensive manual serves as a detailed and user-friendly guide, aiming to facilitate the installation and proficient utilization of fundamental data analysis tools: R, RStudio, and Jamovi. These software packages hold pivotal roles in numerous domains, including the fields of forestry and ecology, where they are instrumental for conducting rigorous statistical analysis, crafting insightful data visualizations, and driving impactful research endeavors.

**Training Success**: Notably, this training manual has played a pivotal role as an integral component of a workshop conducted at the Department of Forestry, Papua New Guinea University of Technology. The foremost aim of this workshop was to empower its participants, the majority of whom were beginners, by equipping them with the essential tools and competencies necessary for proficient data analysis within the specialized domains of forestry and ecology.

**Future Enhancements**: Looking ahead, this manual will continually evolve to encompass more advanced data analysis techniques, including spatial mapping and modeling. These enhancements are designed to cater to the growing needs of researchers, professionals, and students in the fields of forestry and ecology.

**Upcoming Workshops**: Furthermore, this manual will serve as a cornerstone in forthcoming workshops. These workshops are envisioned to delve deeper into complex data analyses, advanced modeling approaches, and the utilization of geospatial data for enhanced ecological insights. We are committed to providing participants with cutting-edge knowledge and practical skills to excel in the dynamic realms of forestry and ecology.
...
-   **Statistical Analysis**: Through this training, participants gain the knowledge and practical skills needed for in-depth statistical analysis, enabling them to test hypotheses, explore correlations, and draw data-driven conclusions.

-   **Data Visualization**: The manual guides participants in leveraging these tools to create informative and visually compelling data visualizations, a vital aspect of data communication.

-   **Research Empowerment**: Equipped with these indispensable tools and the know-how to wield them effectively, attendees are better positioned to contribute meaningfully to research projects, particularly in the domains of forestry and ecology.

By immersing themselves in the contents of this manual, readers will not only attain the capability to install and navigate these software packages but will also gain valuable insights into their practical applications. This newfound proficiency will not only enhance their ability to conduct sound data analysis but will also empower them to make substantial contributions to the fields of forestry and ecology.

Further, by following the instructions outlined in this manual, you will achieve the following objectives:

-   **Install R: R** is a versatile and widely adopted statistical programming language and environment. It empowers researchers and analysts to perform complex data analysis, build statistical models, and create insightful visualizations. This manual will lead you through the installation process for R on your preferred operating system.

-   **Install RStudio: RStudio** is an integrated development environment (IDE) tailored for R users. It offers an intuitive interface and a host of tools to enhance your R programming experience. Installing RStudio, as guided in this manual, will equip you with a user-friendly platform for efficient data analysis and script development.

-   **Install Jamovi: Jamovi** is a user-centric statistical software designed to streamline data analysis and visualization. It excels at making statistical concepts accessible, making it ideal for users new to statistical software. This manual will provide you with a step-by-step walkthrough of the installation process for Jamovi.

With the installation of these tools, you will be well-prepared to embark on data-driven research, hypothesis testing, correlation analysis, and more, ultimately contributing to advancements in the fields of forestry and ecology.
...
1.  Open "Filtered.sav" file in Jamovi. The data should already be placed in the "data" sub-directory.
    ...
    ![open .sav file](images/Screenshot from 2023-09-03 12-14-50.png)

2.  Go to the "Variables" tab and remove the last four columns/ variables as we won't use them.

    ![remove columns](images/Screenshot from 2023-09-03 12-27-30.png)
...
![](images/Screenshot from 2023-09-03 12-21-45.png)
...
3.  **Enable R Syntax Mode**:
    ...
    -   Navigate to the far end right corner of Jamovi window and click on the three vertical dots.
        ...
        ![3 dots](images/Screenshot from 2023-09-03 12-32-43.png)

    -   From the drop-down menu, select "R Syntax Mode." This action switches your analysis interface to R Syntax mode.

        ![Syntax mode](images/Screenshot from 2023-09-03 11-38-22.png){width="183"}
...
4.  **R Syntax Mode**: Once you enable R Syntax Mode, you'll notice that for any analysis or plotting, R codes will appear next to the results.
    ...
    ![syntax](images/Screenshot from 2023-09-03 12-36-01.png)
...
5.  **Writing R Code in Jamovi**:
    ...
    -   You can write and execute R codes directly from within Jamovi's R editor. This is a module which is called "Rj" and can be accessed from the modules library. It must be installed and pinned to the main menu.
        ...
        ![Rj module](images/Screenshot from 2023-09-03 11-50-42.png)

    -   Click on the "Rj" icon and select "Rj editor".

        ![rj editor](images/Screenshot from 2023-09-03 11-53-45.png)
    ...
    -   You can start writing R code directly in the console. For example, you can create variables, perform data manipulations, run statistical analyses, and create visualizations using R syntax. Examples are shown below.
        ...
        ![codes in Rj editor](images/Screenshot from 2023-09-03 11-55-42.png)
...
9.  **Saving and Sharing**: You can save your Jamovi project, which includes your dataset, analyses, and R code. This makes it easy to share your work or collaborate with others.
    ...
    ![save project or workspace (.omv)](images/Screenshot from 2023-09-03 12-12-19.png)

    ![copy plots or results](images/Screenshot from 2023-09-03 11-59-47.png)
