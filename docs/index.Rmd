...
5.  If the installation was successful, you should see a path to the **`make.exe`** executable associated with RTools.
...
8.  **Beware of Multiple Comparisons:** If you are conducting multiple tests on the same dataset, be cautious about the issue of multiple comparisons. Adjusting alpha (e.g., Bonferroni correction) can help control the familywise error rate.
...
![](images/Screenshot from 2023-09-05 13-26-17.png)
...
-   From the "Analyses" tab, select 2 Outcomes (binomial under logistic regression). Compare results and interpretation to R outputs.
    ...
    ![](images/Screenshot from 2023-09-05 15-42-29.png)
